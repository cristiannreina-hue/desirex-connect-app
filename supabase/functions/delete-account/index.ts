...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Cliente con el JWT del usuario para identificarlo de forma segura.
    ...
    // Borrar el perfil dispara cleanup_profile_on_delete (limpia storage,
    // reseñas, suscripciones, pagos, roles, etc.).
